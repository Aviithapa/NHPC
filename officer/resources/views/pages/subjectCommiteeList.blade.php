                ...
                <div class="col-lg-12 m-b-3">
                    <div class="box box-info">
                        <div class="box-header with-border p-t-1">
                            ...
                            <form method="POST" action="{{route("subjectCommittee.dashboard.officer.list", ['level'=>$level,'status'=>  $status,'subject_committee_id' => $subject_commitee_id, 'page'=> $page])}}">
                                @csrf
                                <div class="row">
                                    <div class="col-lg-4">
                        ...
                        <div class="box-body">
                            <div class="table-responsive">
                                    ...
                                    {{ $count = 0 }}
                                        ...
                                        @foreach($datas as $data)
                                            <tr>
                                                ...
                                                <td> <a href="{{url("officer/dashboard/officer/applicant-list-view/".$data->profile_id)}}"><span class="label label-success">View</span></a></td>
                                            </tr>
                                        @endforeach
                                    @endif
                                ...
                                <div class="pagination">
                                    ...
                                    @else
                                        {{++$page}}
                                        <a href="{{route("subjectCommittee.dashboard.officer.list", ['level'=>$level,'status'=>  $status,'subject_committee_id' => $subject_commitee_id, 'page'=> --$page])}}"  class="previous">&laquo; Previous</a>
                                    @endif
                                    <a href="{{route("subjectCommittee.dashboard.officer.list", ['level'=>$level,'status'=>  $status,'subject_committee_id' => $subject_commitee_id, 'page'=> ++$page ])}}"  class="next"> Next &raquo;</a>
                                </div>
                            </div>
                            <!-- /.table-responsive -->
                        </div>
