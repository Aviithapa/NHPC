    ...
    <div class="content-wrapper">
        ...
        <div class="content">
            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-xs-6 m-b-3">
                    <a href="{{route("officer.applicant.profile.list", ['status'=> 'Reviewing', 'current_state' => 'officer','level'=>"4"])}}">
                ...
                <div class="col-lg-3 col-xs-6 m-b-3">
                    <a href="{{route("officer.applicant.profile.list", ['status'=> 'Reviewing', 'current_state' => 'officer','level'=>"3"])}}">
                ...
                <div class="col-lg-3 col-xs-6 m-b-3">
                    <a href="{{route("officer.applicant.profile.list", ['status'=> 'Reviewing', 'current_state' => 'officer','level'=>"2"])}}">
