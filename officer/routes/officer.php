...
Route::get('/officer/applicant-profile-list/{status}/{current_state}/{exam}',[\officer\Http\Controller\OfficerController::class,'profile'])->middleware(['auth'])->name('officer.applicant.profile.list');
