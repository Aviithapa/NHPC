        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-sm-12 col-lg-7">
                    <div class="social-top d-flex align-self-center justify-content-end pt-2">
                        <div class="ml-2 mr-3" >
                            <ul class="list-unstyled d-flex top-nav__language float-right">
                                <li class=""><a href="{{ route('login') }}" >Login</a></li>
                                <li class=""><a href="{{ route('register') }}">New Registrations</a></li>
                                <li class=""><a href="{{ route('register') }}" >KYC Update</a></li>
                                <li class=""><a href="{{ route('admit.card.admitCardPrintSection')}}" class="blink_me">Admit Card</a></li>
    ...
    <div class="bipad-logo mt-3">
        <div class="container">
            <div class="row">
                ...
                <div class="col-sm-1">
                    <div class="img-wrap mt-6 float-right">
                        <img src="{{asset('frontend/images/flag.gif')}}" width="60" alt="">
                    </div>
                </div>
            </div>
        </div>
