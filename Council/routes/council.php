...
Route::get('/officer/subjectCommittee/minuteIndex',[\Council\Http\Controller\CouncilController::class,'minuteDataSubjectCommitteeIndex'])->middleware(['auth'])->name('subjectCommittee.minuteDataSubjectCommitteeIndex.officer');
