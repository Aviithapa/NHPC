...
@section('content')
    ...
    <div class="container">
        ...
        <div class="content-header sty-one">
             <ol class="breadcrumb">
                <li><a href="#">Home</a></li>
                <li><i class="fa fa-angle-right"></i> Print Admit card </li>
            </ol>
        </div>
        ...
        <!-- Main content -->
        <div class="content mt-5" id="printContent">
...
{{--                                                   <img src="https://nhpc.gov.np/beta/uploads/qrcode/Name:Amit T-Qrcode55.png">--}}
                            ...
                            <div class="" style="margin-top: 5rem;">
                                ...
                                <div class="row" style="font-size: 16px; margin-left: 20px; line-height: 1.3;">
                                    ...
                                    <p>(ग)   परीक्षा शुरु हुनुभन्दा १.५ घण्टा अगाडी परीक्षा केन्द्रमा उपस्थित हुनु पर्नेछ ।</p>
