                            ...
                            <div class="table-responsive">
                                <table class="table no-margin">
                                    ...
                                    <tr>
                                        <td><a href="#">TSLC</a></td>
                                        <td>TSLC Licence</td>
                                        <td>यो TSLC तहको नाम दर्ताको लागि मात्र हो | यदि यहाँबाट नाम दर्ता प्रमाणपत्र परीक्षाको लागि  आबेदन   दिएर परीक्षाको लागी अयोग्य भएमा परिषद् जवाफ देहि हुने छैन</td>
                                        <td>
        ...
        <div class="card">
            <div class="card-body conatiner">
                <span class="text-justify text-danger">
                   You have successfully enrolled in the {{isset($licenceExam->Exam_name) ? $licenceExam->Exam_name : 'licence exam'}} please wait until next message
                </span>
