            ...
            <div class="row">
                ...
                <div class="col-lg-4">
                    <fieldset class="form-group">
                        ...
                        <input name="admission_year"  value="{{$data->admission_year}}" class="form-control" id="basicInput" type="number" min="2050"   step="1" placeholder="2075" required/>
                    </fieldset>
                </div>
                <div class="col-lg-4">
                    <fieldset class="form-group">
                        <label>Passed Year </label>
                        <input name="passed_year" value="{{$data->passed_year}}" class="form-control" id="basicInput" type="number" min="2050"  step="1" placeholder="2075" required/>
                    </fieldset>
                </div>
                <div class="col-lg-4">
                    <fieldset class="form-group">
