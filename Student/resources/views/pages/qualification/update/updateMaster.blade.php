        ...
        <form method="POST" action="{{url('student/dashboard/student/qualification/data/'.$data->id)}}">
            ...
            <div class="row">
                ...
                <div class="col-lg-4" id="masterinternational">
                    <fieldset class="form-group">
                        <label>Collage Name</label>
                        <input name="collage_name" value="{{$data->collage_name}}" class="form-control" id="masterinternationalValue" type="text">
                    </fieldset>
                </div>
                ...
                <div class="col-lg-4">
                    <fieldset class="form-group">
                        ...
                        <input name="admission_year"  value="{{$data->admission_year}}" class="form-control" id="basicInput" type="number" min="2050" max="2078" step="1" placeholder="2075" required/>
                    </fieldset>
                </div>
                <div class="col-lg-4">
                    <fieldset class="form-group">
                        <label>Passed Year </label>
                        <input name="passed_year" value="{{$data->passed_year}}" class="form-control" id="basicInput" type="number" min="2050" max="2078" step="1" placeholder="2075" required/>
                    </fieldset>
                </div>
                <div class="col-lg-4">
                    <fieldset class="form-group">
                ...
                <div class="col-lg-4">
                    <fieldset class="form-group">
                        ...
                        <input name="registration_number" value="{{$data->registration_number}}" class="form-control" id="basicInput" type="number" required>
                    </fieldset>
                </div>
                <div class="col-lg-4">
                    <fieldset class="form-group">
