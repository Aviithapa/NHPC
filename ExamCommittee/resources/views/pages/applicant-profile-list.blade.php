                        ...
                        <div class="box-body">
                            <div class="table-responsive">
                                <table id="data-table" class="table no-margin">
                                    ...
                                    @if($data === null)
                                        <tr>
                                            <td> No Applicant List found at Exam Committee</td>
                                        </tr>
                                    ...
                                    @else
                                        ...
                                        <tr>
                                            ...
                                            <td> <a href="{{url("examCommittee/dashboard/examCommittee/applicant-list-view/".$data->id)}}"><span class="label label-success">View</span></a></td>
                                        </tr>
                                            @endforeach
                                         @endforeach
                                    @endif
