...
Route::get('examCommittee/dashboard/export', [ \ExamCommittee\Http\Controller\ExamCommitteeController ::class, 'exportCsv'])->middleware(['auth'])->name('examCommittee.export');
