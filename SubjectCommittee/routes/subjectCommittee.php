...
Route::get('/subjectCommittee/applicant-profile-list/acceptedByMe/{status}/{current_state}/{level}/{page?}', [\SubjectCommittee\Http\Controller\SubjectCommitteeController::class, 'acceptedByMe'])->middleware(['auth'])->name('subjectCommittee.applicant.profile.list.acceptedByMe');
