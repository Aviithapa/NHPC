...
Route::get('/',  function() {
    return view('subjectCommittee::pages.dashboard');})->middleware(['auth'])->name('subjectCommittee.dashboard');
...
Route::get('/subjectCommittee/applicant-profile-list/{status}/{current_state}',[\SubjectCommittee\Http\Controller\SubjectCommitteeController::class,'profile'])->middleware(['auth'])->name('subjectCommittee.applicant.profile.list');
