    ...
    <div class="content-wrapper">
        ...
        <div class="content">
            <div class="row">
                ...
                <div class="col-lg-3 m-b-3">
                    <a href="{{route("subjectCommittee.applicant.profile.list", ['status'=>  $status,'current_state' => $current_state,'level'=>"4"])}}" class="btn {{ (request()->is('/subjectCommittee/dashboard/subjectCommittee/applicant-profile-list/'.$status.'/'.$current_state.'/5')) ? 'btn-primary':''  }}  mt-2"><i class="fa fa-book"></i>
                        Bachelor</a>
                </div>
                <div class="col-lg-3 m-b-3">
                ...
                <div class="col-lg-3 m-b-3">
                    <a href="{{route("subjectCommittee.applicant.profile.list", ['status'=>  $status,'current_state' => $current_state,'level'=>"2"])}}" class="btn {{ (request()->is('/subjectCommittee/dashboard/subjectCommittee/applicant-profile-list/progress/subject_committee/2')) ? 'btn-primary':''  }}  mt-2"><i class="fa fa-book"></i>
                        TSLC</a>
                </div>
            </div>
            <div class="row">
