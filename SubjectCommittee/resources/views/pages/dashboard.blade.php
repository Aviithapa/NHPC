...
{{--                            <div class="info-box-content"> <span class="info-box-number">{{getLevelWiseStudentCountSubject('5',"subject_committee","Reviewing")}}</span>--}}
...
{{--                    <div class="card">--}}
{{--                        <div class="card-body"><span class="info-box-icon bg-aqua"><i class="icon-clock"></i></span>--}}
{{--                            <div class="info-box-content"> <span class="info-box-number">{{getLevelWiseStudentCountSubject('4',"subject_committee","Reviewing")}}</span>--}}
...
{{--                    <div class="card">--}}
{{--                        <div class="card-body"><span class="info-box-icon bg-aqua"><i class="icon-clock"></i></span>--}}
{{--                            <div class="info-box-content"> <span class="info-box-number">{{getLevelWiseStudentCountSubject('3',"subject_committee","Reviewing")}}</span>--}}
...
{{--                    <div class="card">--}}
{{--                        <div class="card-body"><span class="info-box-icon bg-aqua"><i class="icon-clock"></i></span>--}}
{{--                            <div class="info-box-content"> <span class="info-box-number">{{getLevelWiseStudentCountSubject('2',"subject_committee","Reviewing")}}</span>--}}
