                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-4">
                                            <fieldset class="form-group">
                                                ...
                                                <input name="passed_year" class="form-control" id="basicInput" type="number"  step="1" value="{{$data->passed_year}}"  required/>
                                            </fieldset>
                                        </div>
                                        <div class="col-lg-4">
                                            <fieldset class="form-group">
                                    ...
                                    <form method="POST" action="{{url('student/dashboard/student/collage/data')}}">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-4">
                                                <fieldset class="form-group">
                                                    <label>Passed Year </label>
                                                    <input name="passed_year" class="form-control" id="basicInput" type="number"  step="1" value="2075" required/>
                                                </fieldset>
                                            </div>
                                            <div class="col-lg-4">
                                                <fieldset class="form-group">
                                    ...
                                    <form method="POST" action="{{url('student/dashboard/student/collage/data')}}">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-4">
                                                <fieldset class="form-group">
                                                    <label>Admission Year </label>
                                                    <input name="admission_year" class="form-control" id="basicInput" type="number"  step="1" placeholder="2075" required/>
                                                </fieldset>
                                            </div>
                                            <div class="col-lg-4">
                                                <fieldset class="form-group">
                                                    <label>Passed Year </label>
                                                    <input name="passed_year" class="form-control" id="basicInput" type="number"  step="1" placeholder="2075" required/>
                                                </fieldset>
                                            </div>
                                            <div class="col-lg-4">
                                                <fieldset class="form-group">
