            ...
            <ol class="breadcrumb">
                ...
                <div class="content">
                    ...
                    <div class="box-header with-border p-t-1">
                        <form method="POST" 
                        action="{{url('superAdmin/dashboard/search/lost/student')}}">
                            @csrf
                                    ...
                                    <div class="table-responsive">
                                        <table id="data-table" class="table no-margin">
                                            ...
                                            <tr>
                                                ...
                                                <td>{{ $exam->dob_nep }}</td>
                                                <td>{{ $exam->email }}</td>
                                                <td> <a href="{{url("superAdmin/dashboard/applicant-list-view/".$exam->profile_id)}}"><span class="label label-success">View</span></a></td>
