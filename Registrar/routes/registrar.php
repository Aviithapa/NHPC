...
Route::get('/registrar/applicant-profile-list/{status}/{state}/{level}/{page?}',[\Registrar\Http\Controller\RegistrarController::class,'profile'])->middleware(['auth'])->name('registrar.applicant.profile.list');
