                                    ...
                                    @else
                                        @foreach($certificates as $certificate)
                                            <tr>
                                                ...
                                                <td> <a href="{{ $certificate->is_printed == 1 ? url('operator/dashboard/view/printedCertificate/'. $certificate->certificate_history_id .'/'.$certificate->level) : url('operator/dashboard/view/certificate/'. $certificate->certificate_history_id .'/'.$certificate->level)}}"><span class="label label-success">View</span></a>
