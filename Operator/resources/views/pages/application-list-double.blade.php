...
@endphp
    ...
    Voucher Image : <span> <img src="http://103.175.192.52/storage/documents/{{$datas->voucher_image}}" onclick="onClick(this)"  alt="Transcript Image" width="50" height="50"></span>
    ---------------------------------------- <br />
@endforeach
                </td>
