...
">Photo</div>
        ...
        font-weight: 700;">  <input type="text" name="ward"  value="{{ $detail_data->ward }}" /></span> of <span style="font-size: 26px;
        font-weight: 700;">  <input type="text" name="municipality"  value="{{ $detail_data->municipality }} "/></span>
                                            Metropolitan City /Sub-Metropolitan City /Municipality /Rural Municipality
                                            <span style="font-size: 26px;
        font-weight: 700;">   <input type="text" name="district"  value="{{ $detail_data->district }}" /></span> District <span style="font-size: 26px;
        font-weight: 700;">  <input type="text"  name="province"  value="{{ $detail_data->province }}"  > </input></span>

                                            Province is registered as <span style="font-size: 26px;
        font-weight: 700;"><input type="text" name="program_code"  value="{{ $data->program_name }}" /></td></span>
                                            of <span style="font-size: 26px;
        font-weight: 700;"><input type="text" name="level"  value="{{ $data->level_name }}" /></span> Level
...
"> <input type="text" name="registration_number"  value="{{ $data->cert_registration_number}}" /> </span><br>
                                                Date of issue: <span style="        font-size: 22px;
            "><input type="text" name="date_of_issue"  value="{{ $data->issued_date }} " /> </span><br>
