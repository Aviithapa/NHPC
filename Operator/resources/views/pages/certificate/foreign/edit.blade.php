                    ...
                    <div class="box box-info">
                        ...
                        <div class="box-body">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form method="POST" action="{{url('operator/dashboard/certificate/history/update')}}">
                                        @csrf
...
">Photo</div>
        ...
        ">
                                            ...
                                            <input type="text" name="decision_date"  value="{{ $data->decision_date }}"  /> of the Council, the name of
                                            <span style="font-size: 26px;
        font-weight: 600;">  <input type="text" name="name" value="{{ $data->name}}" /></span> date of birth
        ...
        font-weight: 700;">  <input type="text"  name="province"  value="{{ $data->province }}"  > </input></span>

                                            Province is registered as <span style="font-size: 26px;
        font-weight: 700;"><input type="text" name="program_code"  value="{{ $data->program_code }}" /></td></span>
                                            of <span style="font-size: 26px;
        font-weight: 700;"><input type="text" name="level"  value="{{ $data->level }}" /></span> Level
...
"> <input type="text" name="registration_number"  value="{{ $data->registration_number}}" /> </span><br>
                                                Date of issue: <span style="        font-size: 22px;
            "><input type="text" name="date_of_issue"  value="{{ $data->date_of_issue }} " /> </span><br>
        ...
        float: right;">
            ...
            "><input type="text" name="registrar"  value="{{ $data->registrar}}" /></span> <br>
...
">  <input type="text" name="qualification"  value="{{ $data->qualification}}" /></td>
                                                <td style=" border: 1px solid black;
        text-align: center;  font-size: 20px;
        font-weight: bold;

" > <input type="text" name="insitutate" value="{{ $data->insitutate}}" /></td>
                                                <td style=" border: 1px solid black;
        text-align: center;  font-size: 20px;
        font-weight: bold;
...
"></td>
        ...
        border: 1px solid black;">
                                        <div class="footer" style="text-align: center;">
                                            <span style="text-align: center; font-weight: 600; font-size: 16px; word-spacing: 1.6;">Note: - This certificate should be updated in every ,<input type="text" name="time" value="{{ $data->time}}" /> from the date of issue.</span>
                                        </div>
