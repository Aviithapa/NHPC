...
"></td>
        ...
        border: 1px solid black;">
                                        <div class="footer" style="text-align: center;">
                                            <span style="text-align: center; font-weight: 600; font-size: 16px; word-spacing: 1.6;">Note: - This certificate should be updated in every <input type="text" name="time" />, from the date of issue.</span>
                                        </div>
