...
{{--        </tr>--}}
    ...
    <div class="footer" style="text-align: center;">
        <span style="text-align: center; font-weight: 600; font-size: 16px; word-spacing: 1.6;">Note: - This certificate shall remain valid for {{ $data->time }} only from date of issue.</span>
    </div>
    </div>
</page>
