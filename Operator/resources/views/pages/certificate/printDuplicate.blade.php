...
<page size="A4" id="printContent" style="width: 21cm;
    ...
    <div class="printLayout" style="padding: 2.5rem 2rem;">
        <div class="" style="border: 2px solid black; width:170px; text-align: center; padding:2px;"> 
            <span style="text-align:center">Copy Of Original</span>
        </div>
...
"> {{$data->registration_number}}</span><br>
        ...
        float: right;">
            <span style="font-size:20px; margin-right: 190px;">Signature:</span>  <br>
             Name: <span style="font-weight: 700; font-size: 24px;
