...
class CreateExamProcessingDetailsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('exam_processing_details', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('exam_processing_details');
    }
}
